function [output]=read_Intan_RHD2000_file(varargin)
...
% HISTORY
% add compatibility with input argument - SH 20201023
...
output.dataAI=amplifier_data';
output.dataDI=board_dig_in_data';
output.timeStamps=t_amplifier';
output.samplingRate=frequency_parameters.board_adc_sample_rate;
